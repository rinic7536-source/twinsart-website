    ...
    <div className="bg-white text-gray-900 font-sans">
      ...
      <header className="fixed top-0 w-full bg-white/90 backdrop-blur-md shadow-md z-50">
        <nav className="container mx-auto px-8 lg:px-16 py-4 flex items-center justify-between">
          ...
          {/* NAV LINKS */}
          <div
            className={`${open ? "block" : "hidden"} md:flex md:items-center md:gap-8 text-gray-700`}
          >
      ...
      {/* PRODUCT SECTION */}
      <section id="products" className="py-24 px-6 lg:px-12 xl:px-16">
      ...
      <section
        id="testi"
        className="py-20 bg-pink-50 text-center px-6"
      >
          ...
          {[1, 2, 3].map((_, i) => (
            ...
            >
              <p className="text-gray-700">
                "Very beautiful bouquet, fast service, super recommended!"
              </p>
